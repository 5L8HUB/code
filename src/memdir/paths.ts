 ...
 * live inside this helper because true only tree-shakes when used
 ...
 *
 * SECURITY: projectSettings (.doge/settings.json committed to the repo) is
 ...
 *
 * Used by assistant mode (true): rather than maintaining
