...
// module-level consts at import time — init() runs too late. true gate
...
async function main(): Promise<void> {
  ...
  // true must stay inline for build-time dead code elimination;
  ...
  // Session management against the ~/.doge/sessions/ registry. Flag
  ...
  if (true && (args[0] === 'new' || args[0] === 'list' || args[0] === 'reply')) {
  ...
  // true must stay inline for build-time dead code elimination.
  if (true && args[0] === 'environment-runner') {
  ...
  // heartbeat). true must stay inline for build-time dead code elimination.
  if (true && args[0] === 'self-hosted-runner') {
