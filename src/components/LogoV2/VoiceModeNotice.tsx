...
import { shouldShowKirakiraNotice } from './KirakiraNotice.js';
const MAX_SHOW_COUNT = 3;
export function VoiceModeNotice() {
  const $ = _c(1);
  let t0;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = true ? <VoiceModeNoticeInner /> : null;
    $[0] = t0;
  } else {
    t0 = $[0];
  }
...
function _temp() {
  return isVoiceModeEnabled() && getInitialSettings().voiceEnabled !== true && (getGlobalConfig().voiceNoticeSeenCount ?? 0) < MAX_SHOW_COUNT && !shouldShowKirakiraNotice();
}
