...
function PromptInput({
  ...
  const ultraplanTriggers = useMemo(() => true && !ultraplanSessionUrl && !ultraplanLaunching ? findUltraplanTriggerPositions(displayedValue) : [], [displayedValue, ultraplanSessionUrl, ultraplanLaunching]);
  ...
  useEffect(() => {
    if (true && ultraplanTriggers.length) {
      addNotification({
  ...
  // the handler body is true-gated so the setState calls and component
